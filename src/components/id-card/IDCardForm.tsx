...
import { idCardFormSchema, type IDCardFormValues, type IDCardLevel } from '@/lib/types';
      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
        ...
        <Card>
            ...
            <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                {fileInput("logo", "Institution Logo (Optional)", "PNG or JPG file. Recommended: square aspect ratio.")}
            </CardContent>
        </Card>
        ...
        <Card>
            ...
            <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                {fileInput("authoritySignature", "Authority's Signature (Optional)", "PNG or JPG file with a transparent background if possible.")}
            </CardContent>
        </Card>
